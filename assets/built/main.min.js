function dropdown() {
  ...
  if (r) {
    const e = document.querySelector(".gh-head-logo"),
      t = r.innerHTML;
    o.matches &&
      ...
      if (!o.matches) {
        ...
        if (e.length) {
          const t = document.createElement("button"),
            n =
              (t.setAttribute("class", "nav-more-toggle gh-icon-btn"),
...
function pagination(e, a, l = !1) {
  ...
  async function n() {
    ...
    if (t)
      try {
        var e = await (await fetch(t.href)).text(),
        ...
        o.forEach(function (e) {
          ...
          l && (e.style.visibility = "hidden"), r.appendChild(e), s.push(e);
        }),
          c.appendChild(r),
          a && a(s, d);
        var i = n.querySelector("link[rel=next]");
        i && i.href ? (t.href = i.href) : (t.remove(), u && u.remove());
      } catch (e) {
        throw (t.remove(), u && u.remove(), e);
      }
  }
  const o =
    ...
    u = document.querySelector(".gh-loadmore"),
    d =
      (!document.querySelector("link[rel=next]") && u && u.remove(),
      async function () {
        o.getBoundingClientRect().top <= window.innerHeight &&
          document.querySelector("link[rel=next]") &&
          (await n());
      });
  const i = new IntersectionObserver(async function (e) {
    if (!t) {
  ...
  e ? i.observe(o) : u.addEventListener("click", n);
}
  ...
  (navigator.connection &&
    ...
    (o = function (e) {
      ...
      if (!u.has(e) && !c.has(e)) {
        ...
        if (e.substring(0, n.length) === n && window.location.href !== e) {
          for (var o = 0; o < window.FPConfig.ignoreKeywords.length; o++)
            if (e.includes(window.FPConfig.ignoreKeywords[o])) return;
          (t ? (i(e), u) : c).add(e);
        }
      }
    }),
    (t = new IntersectionObserver(function (e) {
      e.forEach(function (e) {
        e.isIntersecting &&
          ((e = e.target.href), o(e, !window.FPConfig.maxRPS));
      });
    })),
    (r = null),
    (e = function (e) {
    ...
    (s = function (e) {
      ...
      e && e.href && !u.has(e.href) && o(e.href, !0);
    }),
    (a = function (e) {
      e = e.target.closest("a");
      e && e.href && !u.has(e.href) && clearTimeout(r);
    }),
    (d =
        ...
        return setTimeout(function () {
          e({
            ...
            timeRemaining: function () {
              return (0, Math.max)(0, 50 - (Date.now() - t));
            },
          });
        }, 1);
      }),
    (l = function () {
      document.querySelectorAll("a").forEach(function (e) {
        ...
        c.clear(),
        document.removeEventListener("mouseover", e, !0),
        document.removeEventListener("mouseout", a, !0),
    ...
    document.addEventListener("mouseover", e, d),
    document.addEventListener("mouseout", a, d),
...
!(function (e, t) {
  ...
  (function (e, t) {
    ...
    return function (o, a) {
      function e(e) {
        if (k) return !0;
        (e = e || window.event), L.timeToIdle && L.mouseUsed && !b && l();
        for (
          var t,
            n,
      ...
      function n() {
        var e = 1 === L.getNumItemsFn();
        e !== C && (_(f, "ui--one-slide", e), (C = e));
      }
      function s() {
        _(v, "share-modal--hidden", P);
      }
      function i() {
        if (
          ((P = !P)
            ...
            : (s(),
              setTimeout(function () {
                P || a.addClass(v, "pswp__share-modal--fade-in");
              }, 30)),
          !P)
        ) {
          for (var e, t, n, o, i = "", r = 0; r < L.shareButtons.length; r++)
            (e = L.shareButtons[r]),
              (t = L.getImageURLForShare(e)),
              (n = L.getPageURLForShare(e)),
              (o = L.getTextForShare(e)),
              (i +=
                '<a href="' +
                e.url
                ...
                e.label +
                "</a>"),
              L.parseShareButtonOut && (i = L.parseShareButtonOut(e, i));
          (v.children[0].innerHTML = i), (v.children[0].onclick = H);
        }
      }
      function r(e) {
        for (var t = 0; t < L.closeElClasses.length; t++)
          if (a.hasClass(e, "pswp__" + L.closeElClasses[t])) return !0;
      }
      function l() {
        clearTimeout(T), (D = 0), b && A.setIdle(!1);
      }
      function c(e) {
      ...
      function u(e) {
        E !== e && (_(x, "preloader--active", !e), (E = e));
      }
      function d(e) {
        var t,
          n = e.vGap;
        !o.likelyTouchDevice || L.mouseUsed || screen.width > L.fitControlsWidth
          ? ((t = L.barsSize),
            L.captionEl && "auto" === t.bottom
              ? (m ||
                  ((m = a.createEl(
                    "pswp__caption pswp__caption--fake"
                  )).appendChild(a.createEl("pswp__caption__center")),
                  f.insertBefore(m, p),
                  a.addClass(f, "pswp__ui--fit")),
                L.addCaptionHTMLFn(e, m, !0)
              ...
              for (var o = 0; o < q.length; o++)
                (s = q[o]),
                  -1 < r.indexOf("pswp__" + s.name) &&
                    (L[s.option]
                      ? (a.removeClass(i, "pswp__element--disabled"),
                        s.onInit && s.onInit(i))
                      : a.addClass(i, "pswp__element--disabled"));
            }
        }
        e(f.children);
        var i,
          r,
          s,
          t = a.getChildByClass(f, "pswp__top-bar");
        t && e(t.children);
      }
      var h,
        f,
      ...
      (A.init = function () {
        var t;
        a.extend(o.options, F, !0),
          (L = o.options),
          (f = a.getChildByClass(o.scrollWrap, "pswp__ui")),
          (w = o.listen)("onVerticalDrag", function (e) {
            M && e < 0.95
              ? A.hideControls()
              : !M && 0.95 <= e && A.showControls();
          }),
          w("onPinchClose", function (e) {
            M && e < 0.9
              ? (A.hideControls(), (t = !0))
              : t && !M && 0.9 < e && A.showControls();
          }),
          w("zoomGestureEnded", function () {
            (t = !1) && !M && A.showControls();
          }),
          ...
          w("doubleTap", function (e) {
            ...
            o.getZoomLevel() !== t
              ? o.zoomTo(t, e, 333)
              : o.zoomTo(L.getDoubleTapZoom(!1, o.currItem), e, 333);
          }),
          ...
          w("bindEvents", function () {
            a.bind(f, "pswpTap click", e),
              a.bind(o.scrollWrap, "pswpTap", A.onGlobalTap),
              o.likelyTouchDevice ||
                a.bind(o.scrollWrap, "mouseover", A.onMouseOver);
          }),
          w("unbindEvents", function () {
            P || i(),
              ...
              a.unbind(o.scrollWrap, "pswpTap", A.onGlobalTap),
              a.unbind(o.scrollWrap, "mouseover", A.onMouseOver),
              h &&
                (a.unbind(document, h.eventK, A.updateFullscreen),
                h.isFullscreen() && ((L.hideAnimationDuration = 0), h.exit()),
                (h = null));
          }),
          w("destroy", function () {
            L.captionEl &&
              (m && f.removeChild(m), a.removeClass(p, "pswp__caption--empty")),
              v && (v.children[0].onclick = null),
              a.removeClass(f, "pswp__ui--over-close"),
              a.addClass(f, "pswp__ui--hidden"),
              A.setIdle(!1);
          }),
          L.showAnimationDuration || a.removeClass(f, "pswp__ui--hidden"),
          ...
          L.fullscreenEl &&
            ...
            ((h = h || A.getFullscreenAPI())
              ? (a.bind(document, h.eventK, A.updateFullscreen),
                A.updateFullscreen(),
                a.addClass(o.template, "pswp--supports-fs"))
              : a.removeClass(o.template, "pswp--supports-fs")),
          L.preloaderEl &&
            (u(!0),
        ...
        (A.update = function () {
          (O = !(
            ...
            L.captionEl &&
              (L.addCaptionHTMLFn(o.currItem, p),
              _(p, "caption--empty", !o.currItem.title)),
            0)
          )),
            P || i(),
            n();
              ...
              r(t)
                ...
                : a.hasClass(t, "pswp__img") &&
                  ...
                  o.getZoomLevel() <= o.currItem.fitRatio
                    ? L.clickToCloseNonZoomable && o.close()
                    : o.toggleDesktopZoom(e.detail.releasePoint));
            else if (
              (L.tapToToggleControls &&
                (M ? A.hideControls() : A.showControls()),
              L.tapToClose && (a.hasClass(t, "pswp__img") || r(t)))
            )
              return void o.close();
        }),
        (A.onMouseOver = function (e) {
          e = (e = e || window.event).target || e.srcElement;
          _(f, "ui--over-close", r(e));
        }),
        (A.hideControls = function () {
          a.addClass(f, "pswp__ui--hidden"), (M = !1);
        }),
        (A.showControls = function () {
          (M = !0), O || A.update(), a.removeClass(f, "pswp__ui--hidden");
        }),
        ...
        (A.getFullscreenAPI = function () {
          ...
          return (
            ...
            e &&
              ...
              (e.exit = function () {
                return (L.closeOnScroll = y), document[this.exitK]();
              }),
  ...
  (function (e, t) {
    ...
    return function (h, F, t, H) {
          ...
          detectFeatures: function () {
            ...
            for (
              ...
              for (var o = c[u], d = 0; d < 3; d++)
                (r = l[d]),
                  (s = o + (o ? r.charAt(0).toUpperCase() + r.slice(1) : r)),
                  !i[r] && s in n && (i[r] = s);
              o &&
                !i.raf &&
                ((o = o.toLowerCase()),
      ...
      function B(e, t, n, o) {
        o === p.currItem.initialZoomLevel
          ? (n[e] = p.currItem.initialPosition[e])
          : ((n[e] = Je(e, o)),
            n[e] > t.min[e]
              ? (n[e] = t.min[e])
      ...
      function Z(e) {
        e && (Ae || Te || y || Le) && (e.preventDefault(), e.stopPropagation());
      }
      function W() {
          ...
          (Jt
            ...
            : (ke && "mousedown" === e.type) ||
              ...
              !u &&
                ...
                I(ft, t[1]),
                _t(A, ft, St),
                (Et.x = Math.abs(St.x) - b.x),
                (Et.y = Math.abs(St.y) - b.y),
                (Pe = Lt(A, ft)))));
      }
      function K(e) {
        var t;
        e.preventDefault(),
          ...
          l &&
            ...
            De || Ae || u
              ...
              : P.x !== x.x * Be
              ? (De = "h")
              : ((e = Math.abs(t[0].x - M.x) - Math.abs(t[0].y - M.y)),
                Math.abs(e) >= ht && ((De = 0 < e ? "h" : "v"), (c = t))));
      }
      function G(e) {
        if (a.isOldAndroid) {
        ...
        S("pointerUp"),
          ...
          fe &&
            -1 < (r = f.arraySearch(mt, e.pointerId, "id")) &&
            ((t = mt.splice(r, 1)[0]),
        ...
        if (
          ...
          u &&
            n < 2 &&
            ((u = !1), 1 === n && (e = "zoomPointerUp"), S("zoomGestureEnded")),
          (c = null),
          Ae || Te || y || Le)
        )
          if ((ct(), (Se = Se || Bt()).calculateSwipeSpeed("x"), Le))
            qt() < m.verticalDragRange
              ? p.close()
              : ((o = b.y),
                (i = Fe),
                ut("verticalDrag", 0, 1, 300, f.easing.cubic.out, function (e) {
                  (b.y = (p.currItem.initialPosition.y - o) * e + o),
                    L((1 - i) * e + i),
                    k();
                }),
                S("onVerticalDrag", 1));
            ...
            if (!y)
              return "swipe" !== e
                ? void Yt()
                : void (!Me && v > p.currItem.fitRatio && Ut(Se));
          }
      }
      var Q,
        $,
        ...
        S = function (e) {
          ...
          if (t) {
            ...
            n.shift();
            for (var o = 0; o < t.length; o++) t[o].apply(p, n);
          }
        },
        C = function () {
        ...
        L = function (e) {
          (Fe = e), (p.bg.style.opacity = e * m.bgOpacity);
        },
        Qe = function (e, t, n, o, i) {
          (!Ke || (i && i !== p.currItem)) && (o /= (i || p.currItem).fitRatio),
            (e[he] = oe + t + "px, " + n + "px" + ie + " scale(" + o + ")");
        },
        k = function (e) {
          _e &&
            (e &&
              (v > p.currItem.fitRatio
                ? Ke || (cn(p.currItem, !1, !0), (Ke = !0))
                : Ke && (cn(p.currItem), (Ke = !1))),
            Qe(_e, b.x, b.y, v));
        },
        $e = function (e) {
          e.container &&
        ...
        Ve = function (e, t) {
          ...
          !m.loop &&
            ...
            (n = Math.round(e - P.x)),
            (t < 0 && 0 < n) || (t >= _() - 1 && n < 0)) &&
            (e = P.x + n * m.mainScrollEndFriction),
            (P.x = e),
            Xe(e, V);
        },
        Je = function (e, t) {
          var n = Et[e] - Ue[e];
          return Re[e] + Ne[e] + n - (t / ne) * n;
        },
        I = function (e, t) {
        ...
        nt = function () {
          tt &&
            (f.unbind(document, "mousemove", nt),
            f.addClass(h, "pswp--has_mouse"),
            (m.mouseUsed = !0),
            S("mouseUsed")),
        ...
        it = function (e) {
          return (e = e || p.currItem).initialZoomLevel;
        },
        rt = function (e) {
          return 0 < (e = e || p.currItem).w ? m.maxSpreadZoom : 1;
        },
        T = {},
        st = 0,
        at = function (e) {
          T[e] && (T[e].raf && me(T[e].raf), st--, delete T[e]);
        },
        lt = function (e) {
          T[e] && at(e), T[e] || (st++, (T[e] = {}));
        },
        ct = function () {
          for (var e in T) T.hasOwnProperty(e) && at(e);
        },
        ut = function (e, t, n, o, i, r, s) {
          function a() {
            T[e] &&
              ((l = C() - c),
              o <= l
                ? (at(e), r(n), s && s())
                : (r((n - t) * i(l / o) + t), (T[e].raf = pe(a))));
          }
          var l,
            c = C();
          lt(e);
        ...
        H = {
          ...
          setScrollOffset: function (e, t) {
            (Ue.x = e), (be = Ue.y = t), S("updateScrollOffset", Ue);
          },
          ...
          init: function () {
            if (!Q && !$) {
              (p.framework = f),
                (p.template = h),
                (p.bg = f.getChildByClass(h, "pswp__bg")),
                (ge = h.className),
                (Q = !0),
                (a = f.detectFeatures()),
                (pe = a.raf),
                ...
                (he = a.transform),
                (ye = a.oldIE),
                (p.scrollWrap = f.getChildByClass(h, "pswp__scroll-wrap")),
                (p.container = f.getChildByClass(
                  p.scrollWrap,
                  "pswp__container"
                )),
                (V = p.container.style),
                (p.itemHolders = s =
                  [
                    { el: p.container.children[0], wrap: 0, index: -1 },
                    { el: p.container.children[1], wrap: 0, index: -1 },
                    { el: p.container.children[2], wrap: 0, index: -1 },
                  ]),
                (s[0].el.style.display = s[2].el.style.display = "none"),
                he
                  ? ((t = a.perspective && !i),
                    (oe = "translate" + (t ? "3d(" : "(")),
                    (ie = a.perspective ? ", 0px)" : ")"))
                  : ((he = "left"),
                    f.addClass(h, "pswp--ie"),
                    (Xe = function (e, t) {
                      t.left = e + "px";
                    }),
                    ($e = function (e) {
                    ...
                    (k = function () {
                      ...
                      _e &&
                        ((e = _e),
                        (n =
                          (o = 1 < (t = p.currItem).fitRatio ? 1 : t.fitRatio) *
                          t.w),
                        (o = o * t.h),
                        (e.width = n + "px"),
                        (e.height = o + "px"),
                  ...
                  orientationchange: function () {
                    clearTimeout(we),
                      (we = setTimeout(function () {
                        w.x !== p.scrollWrap.clientWidth && p.updateSize();
                      }, 500));
                  },
                  scroll: W,
                  keydown: U,
              ...
              for (
                ...
                p["init" + We[e]]();
              F && (p.ui = new F(p, f)).init(),
                S("firstUpdate"),
                (g = g || m.index || 0),
                (isNaN(g) || g < 0 || g >= _()) && (g = 0),
                (p.currItem = en(g)),
                (a.isOldIOSPhone || a.isOldAndroid) && (Ze = !1),
                h.setAttribute("aria-hidden", "false"),
                m.modal &&
                  (Ze
                    ? (h.style.position = "fixed")
                    : ((h.style.position = "absolute"),
                      (h.style.top = f.getScrollY() + "px"))),
                void 0 === be &&
                  (S("initialLayout"), (be = ve = f.getScrollY()));
              var n = "pswp--open ";
              for (
                m.mainClass && (n += m.mainClass + " "),
                  m.showHideOpacity && (n += "pswp--animate_opacity "),
                  n =
                    (n =
                ...
                Xe((e + J) * x.x, s[e].el.style);
              ye || f.bind(p.scrollWrap, te, p),
                r("initialZoomInEnd", function () {
                  p.setContent(s[0], g - 1),
                    p.setContent(s[2], g + 1),
                    (s[0].el.style.display = s[2].el.style.display = "block"),
                    m.focus && h.focus(),
                    f.bind(document, "keydown", p),
                    a.transform && f.bind(p.scrollWrap, "click", p),
                    m.mouseUsed || f.bind(document, "mousemove", nt),
                    f.bind(window, "resize scroll orientationchange", p),
                    S("bindEvents");
                }),
                p.setContent(s[1], g),
                p.updateCurrItem(),
                ...
                Ze ||
                  (re = setInterval(function () {
                    st ||
                      l ||
                      u ||
                      v !== p.currItem.initialZoomLevel ||
                      p.updateSize();
                  }, 1e3)),
                f.addClass(h, "pswp--visible");
            }
            var t;
          },
          close: function () {
            Q &&
              (($ = !(Q = !1)),
              S("close"),
              f.unbind(window, "resize scroll orientationchange", p),
              f.unbind(window, "scroll", o.scroll),
              f.unbind(document, "keydown", p),
              f.unbind(document, "mousemove", nt),
              a.transform && f.unbind(p.scrollWrap, "click", p),
              l && f.unbind(window, ee, p),
              clearTimeout(we),
              S("unbindEvents"),
              tn(p.currItem, null, !0, p.destroy));
          },
          destroy: function () {
            S("destroy"),
              $t && clearTimeout($t),
              ...
              (h.className = ge),
              re && clearInterval(re),
              f.unbind(p.scrollWrap, te, p),
              f.unbind(window, "scroll", p),
              kt(),
              ct(),
              (Ge = null);
          },
          ...
          updateCurrZoomItem: function (e) {
            ...
            e && S("beforeChange", 0),
              (_e =
                ...
                ((t = s[1].el.children[0]), f.hasClass(t, "pswp__zoom-wrap"))
                  ? t.style
                  : null),
              (d = p.currItem.bounds),
              (ne = v = p.currItem.initialZoomLevel),
              (b.x = d.center.x),
              (b.y = d.center.y),
              e && S("afterChange");
          },
              ...
              if (!(e && n < 2)) {
                ...
                for (var o = 0; o < n; o++)
                  0 < E
                    ? ((t = s.shift()),
                      (s[2] = t),
                      Xe((++J + 2) * x.x, t.el.style),
                      p.setContent(t, g - n + o + 1 + 1))
                    : ((t = s.pop()),
                      s.unshift(t),
                      Xe(--J * x.x, t.el.style),
                      p.setContent(t, g + n - o - 1 - 1));
          ...
          updateSize: function (e) {
            if (!Ze && m.modal) {
              ...
              if (
                ...
                !e && Ye.x === window.innerWidth && Ye.y === window.innerHeight)
              )
                return;
              (Ye.x = window.innerWidth),
                (Ye.y = window.innerHeight),
                (h.style.height = Ye.y + "px");
            }
            if (
              ((w.x = p.scrollWrap.clientWidth),
              (w.y = p.scrollWrap.clientHeight),
              W(),
              (x.x = w.x + Math.round(w.x * m.spacing)),
              (x.y = w.y),
              Ve(x.x * Be),
              S("beforeResize"),
              void 0 !== J)
              ...
              for (var n, o, i, r = 0; r < 3; r++)
                (n = s[r]),
                  Xe((r + J) * x.x, n.el.style),
                  (i = g + r - 1),
                  m.loop && 2 < _() && (i = R(i)),
                  (o = en(i)) && (se || o.needsUpdate || !o.bounds)
                    ? (p.cleanSlide(o),
                      p.setContent(n, i),
                      1 === r && ((p.currItem = o), p.updateCurrZoomItem(!0)),
                      (o.needsUpdate = !1))
                    : -1 === n.index && 0 <= i && p.setContent(n, i),
                  o && o.container && (an(o, w), cn(o), $e(o));
              se = !1;
            }
            (ne = v = p.currItem.initialZoomLevel),
              (d = p.currItem.bounds) &&
                ((b.x = d.center.x), (b.y = d.center.y), k(!0)),
              S("resize");
          },
          zoomTo: function (t, e, n, o, i) {
            e &&
              ((ne = v),
              (Et.x = Math.abs(e.x) - b.x),
              (Et.y = Math.abs(e.y) - b.y),
              I(Re, b));
            function r(e) {
              1 === e
                ? ((v = t), (b.x = s.x), (b.y = s.y))
            ...
            var e = ot(t, !1),
              s = {},
              a = (B("x", e, s, t), B("y", e, s, t), v),
              l = { x: b.x, y: b.y };
            et(s);
            n ? ut("customZoomTo", 0, 1, n, o || f.easing.sine.inOut, r) : r(1);
          },
        },
        dt = 30,
        ht = 10,
        ...
        Tt = function () {
          return !("fit" === m.scaleMode && v === p.currItem.initialZoomLevel);
        },
        At = function (e, t) {
          return (
            !(!e || e === document) &&
        ...
        Mt = function (e, t) {
          return (
            (Ot.prevent = !At(e.target, m.isClickableElement)),
            S("preventDragEvent", e, t, Ot),
            Ot.prevent
          );
        },
        Pt = function (e, t) {
        ...
        qt = function () {
          var e = b.y - p.currItem.initialPosition.y;
            ...
            fe
              ? ((ze = 0),
                mt.forEach(function (e) {
                  0 === ze ? (Ht[0] = e) : 1 === ze && (Ht[1] = e), ze++;
                }))
              : -1 < e.type.indexOf("touch")
              ? e.touches &&
                0 < e.touches.length &&
                ((Ht[0] = Pt(e.touches[0], jt)), 1 < e.touches.length) &&
                (Ht[1] = Pt(e.touches[1], Ft))
              : ((jt.x = e.pageX),
                (jt.y = e.pageY),
                (jt.id = ""),
                (Ht[0] = jt)),
        ...
        Nt = function (e, t) {
          var n,
            ...
            a = P.x + t.x,
            l = P.x - gt.x,
            c = r > d.min[e] || r < d.max[e] ? m.panEndFriction : 1,
            r = b[e] + t[e] * c;
          return (!m.allowPanToNext && v !== p.currItem.initialZoomLevel) ||
            (_e
              ? "h" !== De ||
                "x" !== e ||
                Te ||
                (s
                  ...
                  : (r < d.max[e] &&
                      ...
                      (n = Re[e] - d.max[e])),
                    (n <= 0 || 0 < l) && 1 < _()
                      ? ((i = a), 0 < l && a < gt.x && (i = gt.x))
                      : d.min.x !== d.max.x && (o = r)))
              : (i = a),
            "x" !== e)
            ? void (y || Me || (v > p.currItem.fitRatio && (b[e] += t[e] * c)))
            : (void 0 !== i && (Ve(i, !0), (Me = i !== gt.x)),
              d.min.x !== d.max.x &&
                (void 0 !== o ? (b.x = o) : Me || (b.x += t.x * c)),
              void 0 !== i);
        },
        Rt = function () {
          var e, t, n, o, i, r;
          c &&
            ...
            u && 1 < e
              ? ((M.x = A.x),
                ...
                (!O.x && !O.y && Ct(c[1], ft)) ||
                  (I(ft, c[1]),
                  Te || ((Te = !0), S("zoomGestureStarted")),
                  (e = Lt(A, ft)),
                  (t = Wt(e)) >
                    p.currItem.initialZoomLevel +
                      p.currItem.initialZoomLevel / 15 && (He = !0),
                  (n = 1),
                  (o = it()),
                  (i = rt()),
                  t < o
                    ? m.pinchToClose && !He && ne <= p.currItem.initialZoomLevel
                      ? (L((r = 1 - (o - t) / (o / 1.2))),
                        S("onPinchClose", r),
                        (je = !0))
              ...
              : De &&
                (qe &&
                  ((qe = !1),
                  Math.abs(O.x) >= ht && (O.x -= c[0].x - pt.x),
                  Math.abs(O.y) >= ht) &&
                  (O.y -= c[0].y - pt.y),
                (M.x = A.x),
                (M.y = A.y),
                (0 === O.x && 0 === O.y) ||
                  ("v" === De && m.closeOnVerticalDrag && !Tt()
                    ? ((Ne.y += O.y),
                      (b.y += O.y),
                      (r = qt()),
                      (Le = !0),
          ...
          var t,
            ...
            o = {
              ...
              calculateSwipeSpeed: function (e) {
                (n = (
                  1 < vt.length
                    ? ((t = C() - Ee + 50), vt[vt.length - 2])
                    : ((t = C() - xe), pt)
                )[e]),
                  (o.lastFlickOffset[e] = M[e] - n),
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                o.backAnimStarted[t] ||
                  (b[t] > d.min[t]
                    ...
                    : b[t] < d.max[t] && (o.backAnimDestination[t] = d.max[t]),
              ...
              calculateAnimOffset: function (e) {
                o.backAnimStarted[e] ||
                  ...
                  (o.distanceOffset[e] =
                    ...
                    o.speedDecelerationRatio[e] *
                    o.timeDiff),
                  (b[e] += o.distanceOffset[e]));
              },
              panAnimLoop: function () {
                T.zoomPan &&
                  ((T.zoomPan.raf = pe(o.panAnimLoop)),
                  (o.now = C()),
        ...
        Zt = function (e, t) {
          ...
          y || (bt = g),
            ...
            o &&
              ((g += o) < 0
                ? ((g = m.loop ? _() - 1 : 0), (i = !0))
                : g >= _() && ((g = m.loop ? 0 : _() - 1), (i = !0)),
              (i && !m.loop) || ((E += o), (Be -= o), (n = !0)));
          var e = x.x * Be,
            r = Math.abs(e - P.x),
            s =
              n || e > P.x == 0 < t.lastFlickSpeed.x
                ? ((s =
          ...
          return (
            ...
            ut("mainScroll", P.x, e, s, f.easing.cubic.out, Ve, function () {
              ct(),
                (y = !1),
                (bt = -1),
                (!n && bt === g) || p.updateCurrItem(),
                S("mainScrollAnimComplete");
            }),
            n && p.updateCurrItem(!0),
            n
          );
        },
        Wt = function (e) {
          ...
          return (
            je && !Ce && !He && v < t
              ...
              : (je &&
                ...
                p.zoomTo(e, 0, 200, f.easing.cubic.out, o)),
            !0
          );
        };
      N("Gestures", {
        publicMethods: {
          initGestures: function () {
            ...
            (fe = a.pointerEvent) && a.touch && (a.touch = !1),
              fe
                ? navigator.msPointerEnabled
      ...
      var $t,
        ...
        tn = function (r, e, s, t) {
          function a() {
            at("initialZoom"),
              s
                ? (p.template.removeAttribute("style"),
                  p.bg.removeAttribute("style"))
                : (L(1),
                  e && (e.style.display = "block"),
                  f.addClass(h, "pswp--animated-in"),
                  S("initialZoom" + (s ? "OutEnd" : "InEnd"))),
              t && t(),
              (Jt = !1);
          }
          $t && clearTimeout($t),
          ...
          var l,
            c,
            u,
            d = s ? m.hideAnimationDuration : m.showAnimationDuration;
          d && l && void 0 !== l.x
            ? ((c = X),
              (u =
                !p.currItem.src || p.currItem.loadError || m.showHideOpacity),
              r.miniImg &&
              ...
              s ||
                ...
                (b.x = l.x),
                (b.y = l.y - ve),
                (p[u ? "template" : "bg"].style.opacity = 0.001),
                k()),
              lt("initialZoom"),
              s && !c && f.removeClass(h, "pswp--animated-in"),
              u &&
                (s
                  ? f[(c ? "remove" : "add") + "Class"](
                      h,
                      ...
                      ? ((t = l.w / r.w),
                        ...
                        (e = function (e) {
                          1 === e
                            ...
                            k(),
                            u ? (h.style.opacity = 1 - e) : L(i - e * i);
                        }),
                        c
                          ? ut("initialZoom", 0, 1, d, f.easing.cubic.out, e, a)
                          : (e(1), ($t = setTimeout(a, d + 20))))
                      : ((v = r.initialZoomLevel),
                        I(b, r.initialPosition),
                        k(),
                        L(1),
                        u ? (h.style.opacity = 1) : L(1),
                        ($t = setTimeout(a, d + 20)));
                },
                s ? 25 : 90
              )))
        ...
        sn = function (e, t, n) {
          var o = e.bounds;
          (o.center.x = Math.round((D.x - t) / 2)),
            (o.center.y = Math.round((D.y - n) / 2) + e.vGap.top),
            (o.max.x = t > D.x ? Math.round(D.x - t) : o.center.x),
            (o.max.y = n > D.y ? Math.round(D.y - n) + e.vGap.top : o.center.y),
            (o.min.x = t > D.x ? 0 : o.center.x),
            (o.min.y = n > D.y ? e.vGap.top : o.center.y);
        },
        an = function (e, t, n) {
          var o, i;
          return e.src && !e.loadError
            ? ((o = !n) &&
                ...
                S("parseVerticalMargin", e)),
              (D.x = t.x),
              (D.y = t.y - e.vGap.top - e.vGap.bottom),
              o &&
                ((t = D.x / e.w),
                (i = D.y / e.h),
                (e.fitRatio = t < i ? t : i),
        ...
        publicMethods: {
            ...
            f.extend(m, on, !0),
              ...
              r("beforeChange", function (e) {
                for (
                  ...
                  p.lazyLoadItem(g + r);
                for (r = 1; r <= (n ? o : i); r++) p.lazyLoadItem(g - r);
              }),
              r("initialLayout", function () {
                p.currItem.initialLayout =
              ...
              r("destroy", function () {
                for (var e, t = 0; t < Xt.length; t++)
                  (e = Xt[t]).container && (e.container = null),
          ...
          setContent: function (t, n) {
            ...
            e
              ? (S("gettingData", n, e),
                (t.index = n),
                (i = (t.item = e).container = f.createEl("pswp__zoom-wrap")),
                !e.src &&
                  e.html &&
                  (e.html.tagName
                        ...
                        if (t && t.index === n) {
                          if (Gt(e, !0))
                            return (
                              ...
                              an(e, w),
                              $e(e),
                              void (t.index === g && p.updateCurrZoomItem())
                            );
                          e.imageAppended
                            ? !Jt &&
                              e.placeholder &&
                            ...
                            : ln(n, e, i, e.img, y || Jt, !0);
                        }
                        (e.loadComplete = null),
                          (e.img = null),
                          S("imageLoadComplete", n, e);
                      }
                    }),
                    f.features.transform &&
                      ((r = "pswp__img pswp__img--placeholder"),
                      (r += e.msrc ? "" : " pswp__img--placeholder--blank"),
                      (r = f.createEl(r, e.msrc ? "img" : "")),
                      e.msrc && (r.src = e.msrc),
                      cn(e, r),
                      i.appendChild(r),
                      (e.placeholder = r)),
                    e.loading || Kt(e),
                    p.allowProgressiveImg() &&
                      (!Vt && a.transform
                        ? nn.push({
                            item: e,
                            baseDiv: i,
                        ...
                        : ln(n, e, i, e.img, !0, !0))),
                Vt || n !== g ? $e(e) : ((_e = i.style), tn(e, o || e.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(i))
              : (t.el.innerHTML = "");
          },
      ...
      N("Tap", {
        publicMethods: {
          initTap: function () {
            r("firstTouchStart", p.onTapStart),
              r("touchRelease", p.onTapRelease),
              r("destroy", function () {
                (hn = {}), (dn = null);
              });
          },
        ...
        N("DesktopZoom", {
          publicMethods: {
            ...
            setupDesktopZoom: function (e) {
              ...
              r("bindEvents", function () {
                ...
                r("unbindEvents", function () {
                  q && f.unbind(h, t, p.handleMouseWheel);
                }),
                (p.mouseZoomedIn = !1);
              function n() {
                p.mouseZoomedIn &&
                  (f.removeClass(h, "pswp--zoomed-in"), (p.mouseZoomedIn = !1)),
                  v < 1
                    ? f.addClass(h, "pswp--zoom-allowed")
                    : f.removeClass(h, "pswp--zoom-allowed"),
                  i();
              }
              var o,
                i = function () {
                  o && (f.removeClass(h, "pswp--dragging"), (o = !1));
                };
              r("resize", n),
                r("afterChange", n),
                r("pointerDown", function () {
                  p.mouseZoomedIn &&
                    ((o = !0), f.addClass(h, "pswp--dragging"));
                }),
                r("pointerUp", i),
                e || n();
            },
            handleMouseWheel: function (e) {
              if (v <= p.currItem.fitRatio)
                return (
                  m.modal &&
                    (!m.closeOnScroll || st || l
                      ? e.preventDefault()
                      : he && 2 < Math.abs(e.deltaY) && ((X = !0), p.close())),
                  !0
                );
              if ((e.stopPropagation(), (q.x = 0), "deltaX" in e))
                1 === e.deltaMode
                  ? ((q.x = 18 * e.deltaX), (q.y = 18 * e.deltaY))
                  : ((q.x = e.deltaX), (q.y = e.deltaY));
              else if ("wheelDelta" in e)
                e.wheelDeltaX && (q.x = -0.16 * e.wheelDeltaX),
                  e.wheelDeltaY
                    ? (q.y = -0.16 * e.wheelDeltaY)
                    : (q.y = -0.16 * e.wheelDelta);
              else {
            ...
            toggleDesktopZoom: function (e) {
              e = e || { x: w.x / 2 + Ue.x, y: w.y / 2 + Ue.y };
              var t = m.getDoubleTapZoom(!0, p.currItem),
                n = v === t;
              (p.mouseZoomedIn = !n),
                p.zoomTo(n ? p.currItem.initialZoomLevel : t, e, 333),
                f[(n ? "remove" : "add") + "Class"](h, "pswp--zoomed-in");
            },
          },
        });
      function fn() {
      ...
      function pn() {
        ...
        if (!(e.length < 5)) {
          ...
          if (m.galleryPIDs) {
            for (var i = t.pid, r = (t.pid = 0); r < Xt.length; r++)
              if (Xt[r].pid === i) {
                t.pid = r;
                break;
              }
      ...
      var mn,
        ...
        j,
        Cn,
        Ln = { history: !0, galleryUID: 1 },
        kn = function () {
          return j.hash.substring(1);
        },
        In = function () {
          var e, t;
          vn && clearTimeout(vn),
            st || l
              ? (vn = setTimeout(In, 500))
              : (yn ? clearTimeout(gn) : (yn = !0),
                (t = g + 1),
                (e = en(g)).hasOwnProperty("pid") && (t = e.pid),
                (e = n + "&gid=" + m.galleryUID + "&pid=" + t),
                xn || (-1 === j.hash.indexOf(e) && (Sn = !0)),
                (t = j.href.split("#")[0] + "#" + e),
                Cn
            ...
            f.extend(m, Ln, !0),
              m.history &&
                ...
                -1 < (t = n.indexOf("pid=")) &&
                  ...
                  (n = n.slice(0, -1)),
                setTimeout(function () {
                  Q && f.bind(window, "hashchange", p.onHashChange);
                }, 40));
          },
          onHashChange: function () {
            return kn() === n
              ? ((En = !0), void p.close())
              : void (yn || ((bn = !0), p.goTo(pn().pid), (bn = !1)));
          },
          updateURL: function () {
            fn(), bn || (xn ? (mn = setTimeout(In, 800)) : In());
          },
        },
      }),
        f.extend(p, H);
  ...
  (function (e, t) {
    ...
    function t() {
      ...
      for (var o = Array(e), i = 0, t = 0; t < n; t++)
        for (var r = arguments[t], s = 0, a = r.length; s < a; s++, i++)
          o[i] = r[s];
      return o;
    }
    return function (e, i) {
          ...
          return "string" == typeof e
            ? ((t = d.call(arguments, 1)),
              ...
              (t = this).each(function (e, t) {
                ...
                t
                  ? (n = t[o]) && "_" != o.charAt(0)
                    ? ((n = n.apply(t, i)), (r = void 0 === r ? n : r))
                    : h(s + " is not a valid method")
                  : h(l + " not initialized. Cannot call methods, i.e. " + s);
              }),
              void 0 !== r ? r : t)
            : ((a = e),
          ...
          return (
            e.forEach(function (e) {
              if (e instanceof HTMLElement)
                if (o) {
                  r(e, o) && i.push(e);
                  for (var t = e.querySelectorAll(o), n = 0; n < t.length; n++)
                    i.push(t[n]);
                } else i.push(e);
            }),
            i
      ...
      (l.htmlInit = function (s, a) {
        l.docReady(function () {
          ...
          t.forEach(function (t) {
            var e,
              n = t.getAttribute(o) || t.getAttribute(i);
            try {
              e = n && JSON.parse(n);
            } catch (e) {
              return void (
                c &&
                c.error("Error parsing " + o + " on " + t.className + ": " + e)
              );
            }
            n = new s(t, e);
            r && r.data(t, a, n);
  ...
  (function (n, o) {
    ...
    function r(e, t) {
      ...
      if (o)
        return (e = o).infiniteScrollGUID
          ? ((n = a[e.infiniteScrollGUID]).option(t), n)
          : ((this.element = e),
            (this.options = i.extend({}, r.defaults)),
            this.option(t),
            s && (this.$element = s(this.element)),
            void this.create());
      console.error("Bad element for InfiniteScroll: " + (o || e));
    }
    var s = t.jQuery,
      a = {},
      n = ((r.defaults = {}), (r.create = {}), (r.destroy = {}), r.prototype),
      o = (i.extend(n, e.prototype), 0),
      l =
        ((n.create = function () {
          var e = (this.guid = ++o);
          if (
            ((this.element.infiniteScrollGUID = e),
            ((a[e] = this).pageIndex = 1),
            (this.loadCount = 0),
            this.updateGetPath(),
            this.getPath && this.getPath())
          )
            for (var t in (this.updateGetAbsolutePath(),
            this.log("initialized", [this.element.className]),
            this.callOnInit(),
            r.create))
              r.create[t].call(this);
        ...
        (n.dispatchEvent = function (e, t, n) {
          this.log(e, n);
      ...
      c =
        ...
        (n.updateGetPath = function () {
          ...
          if (e) {
            var t = typeof e;
            if ("function" != t)
              return "string" == t && e.match("{{#}}")
                ? void this.updateGetPathTemplate(e)
                : void this.updateGetPathSelector(e);
            this.getPath = e;
          } else
            console.error("InfiniteScroll path option required. Set as: " + e);
        }),
        (n.updateGetPathTemplate = function (t) {
          ...
          e &&
            ((this.pageIndex = parseInt(e[1], 10)),
    ...
    return (
      (n.updateGetPathSelector = function (e) {
        var t = document.querySelector(e);
        if (t) {
          for (
            var n, o = t.getAttribute("href"), i = 0;
            o && i < c.length;
            i++
          ) {
            var r = o.match(c[i]);
      ...
      (n.destroy = function () {
        for (var e in (this.allOff(), r.destroy)) r.destroy[e].call(this);
        delete this.element.infiniteScrollGUID,
          delete a[this.guid],
          s && this.$element && s.removeData(this.element, "infiniteScroll");
      }),
      (r.throttle = function (o, i) {
        var r, s;
        return (
          (i = i || 200),
          function () {
            ...
            r && e < r + i ? (clearTimeout(s), (s = setTimeout(n, i))) : n();
          }
        );
      }),
      (r.data = function (e) {
        e = (e = i.getQueryElement(e)) && e.infiniteScrollGUID;
        return e && a[e];
      }),
  ...
  (function (t, n) {
    "function" == typeof define && define.amd
      ? define("infinite-scroll/js/page-load", ["./core"], function (e) {
          return n(t, e);
        })
      : "object" == typeof module && module.exports
      ? (module.exports = n(t, require("./core")))
      : n(t, t.InfiniteScroll);
  })(window, function (o, i) {
    function d(e) {
      for (
    ...
    var e = i.prototype;
    return (
      (i.defaults.loadOnScroll = !0),
      (i.defaults.checkLastPage = !0),
      (i.defaults.responseType = "document"),
      (i.create.pageLoad = function () {
        (this.canLoad = !0),
      ...
      (e.loadNextPage = function () {
        ...
        !this.isLoading &&
          ...
          (a = n),
          (l = o),
          (c = new XMLHttpRequest()).open("GET", i, !0),
          (c.responseType = r || ""),
          ...
          (c.onload = function () {
            ...
            200 == c.status
              ...
              : 204 == c.status
              ? l(c.response)
              : ((e = new Error(c.statusText)), a(e));
          }),
          (c.onerror = function () {
            var e = new Error("Network error requesting " + i);
            a(e);
          }),
          c.send(),
          this.dispatchEvent("request", null, [t]));
      }),
      (e.onPageLoad = function (e, t) {
        return (
          this.options.append || (this.isLoading = !1),
          this.pageIndex++,
          this.loadCount++,
          this.dispatchEvent("load", null, [e, t]),
          this.appendNextPage(e, t),
          e
        );
      }),
      (e.appendNextPage = function (e, t) {
        var n,
          o,
          i = this.options.append;
        "document" == this.options.responseType &&
          i &&
          ...
          (i = function () {
            this.appendItems(n, o),
              (this.isLoading = !1),
              this.dispatchEvent("append", null, [e, t, n]);
          }.bind(this)),
          this.options.outlayer ? this.appendOutlayerItems(o, i) : i());
      }),
      (e.appendItems = function (e, t) {
        if (e && e.length) {
          for (
            var n = (t = t || d(e)).querySelectorAll("script"), o = 0;
            o < n.length;
            o++
          ) {
            for (
            ...
            (r.innerHTML = i.innerHTML), i.parentNode.replaceChild(r, i);
          }
          this.element.appendChild(t);
        }
      }),
      (e.appendOutlayerItems = function (e, t) {
        var n = i.imagesLoaded || o.imagesLoaded;
        return n
          ? void n(e, t)
          : (console.error(
      ...
      (e.onAppendOutlayer = function (e, t, n) {
        this.options.outlayer.appended(n);
      }),
      (e.checkLastPage = function (e, t) {
        ...
        if (n) {
          ...
          "string" == typeof n ? (o = n) : this.isPathSelector && (o = i),
            o &&
              e.querySelector &&
              (e.querySelector(o) || this.lastPageReached(e, t));
        }
      }),
      (e.lastPageReached = function (e, t) {
        (this.canLoad = !1), this.dispatchEvent("last", null, [e, t]);
      }),
      (e.onPageError = function (e, t) {
        return (
          (this.isLoading = !1),
          (this.canLoad = !1),
          this.dispatchEvent("error", null, [e, t]),
          e
        );
      }),
      (i.create.prefill = function () {
        var e;
        this.options.prefill &&
          ((e = this.options.append)
  ...
  (function (n, o) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = o(n, require("./core"), require("fizzy-ui-utils")))
  ...
  (function (n, o) {
    ...
    var o = e.prototype,
      i = ((e.defaults.history = "replace"), document.createElement("a"));
    return (
      ...
      (o.createHistoryAppend = function () {
        this.updateMeasurements(),
          this.updateScroller(),
          (this.scrollPages = [
      ...
      (o.bindHistoryAppendEvents = function (e) {
        e = e ? "addEventListener" : "removeEventListener";
        this.scroller[e]("scroll", this.scrollHistoryHandler),
          t[e]("unload", this.unloadHandler);
      }),
      (o.createHistoryPageLoad = function () {
        this.on("load", this.onPageLoadHistory);
      }),
      (e.destroy.history = o.destroyHistory =
        function () {
          this.options.history &&
            this.options.append &&
            this.bindHistoryAppendEvents(!1);
        }),
      (o.onAppendHistory = function (e, t, n) {
        n &&
          n.length &&
          ((n = n[0]),
          (n = this.getElementScrollY(n)),
          (i.href = t),
          this.scrollPages.push({ top: n, path: i.href, title: e.title }));
      }),
      (o.getElementScrollY = function (e) {
        return this.options.elementScroll
          ? this.getElementElementScrollY(e)
          : this.getElementWindowScrollY(e);
      }),
      (o.getElementWindowScrollY = function (e) {
        return e.getBoundingClientRect().top + t.pageYOffset;
      }),
      (o.getElementElementScrollY = function (e) {
        return e.offsetTop - this.top;
      }),
      (o.onScrollHistory = function () {
        for (
          var e, t, n = this.getScrollViewY(), o = 0;
          o < this.scrollPages.length;
          o++
        ) {
          var i = this.scrollPages[o];
          if (i.top >= n) break;
          (e = o), (t = i);
        }
        e != this.scrollPageIndex &&
          ((this.scrollPageIndex = e), this.setHistory(t.title, t.path));
      }),
      n.debounceMethod(e, "onScrollHistory", 150),
      (o.getScrollViewY = function () {
        return this.options.elementScroll
          ? this.scroller.scrollTop + this.scroller.clientHeight / 2
          : t.pageYOffset + this.windowHeight / 2;
      }),
      (o.setHistory = function (e, t) {
      ...
      (o.onUnload = function () {
        ...
        0 !== e &&
          ((e = this.scrollPages[e]),
          (e = t.pageYOffset - e.top + this.top),
          this.destroyHistory(),
          scrollTo(0, e));
      }),
      (o.onPageLoadHistory = function (e, t) {
  ...
  (function (e, n) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = n(0, require("./core"), require("fizzy-ui-utils")))
      : n(0, e.InfiniteScroll, e.fizzyUIUtils);
  ...
  (function (e, n) {
    ...
    return (
      ...
      (s.hideStatusEventElements = function () {
        for (var e in this.statusEventElements) o(this.statusEventElements[e]);
      }),
      t
    );
  }),
  ...
  (function (t, n) {
    ...
    function s(e, t, n) {
      ...
      return this instanceof s
        ? (o = "string" == typeof (o = e) ? document.querySelectorAll(e) : o)
          ? ((this.elements =
              ((i = o),
              Array.isArray(i)
                ? i
          ...
          : void l.error("Bad element for imagesLoaded " + (o || e))
        : new s(e, t, n);
    }
    function n(e) {
      this.img = e;
  ...
  document.addEventListener("DOMContentLoaded", function () {
    document.querySelector(".pagination-section a") &&
      new InfiniteScroll(".loop-section", {
        ...
        history: !1,
        scrollThreshold: !1,
      }).on("append", function (e, t, n) {
        for (var o = 0; o < n.length; o++) {
          a = s = r = i = void 0;
          for (
            var i = n[o], r = i.querySelectorAll("img[srcset]"), s = 0;
            s < r.length;
            s++
          ) {
            var a = r[s];
  ...
  (function () {
    if (document.body.classList.contains("post-template")) {
      const e = document.querySelector(".gh-cover");
      if (e) {
        const t = e.querySelector(".gh-cover-image");
        window.addEventListener("load", function () {
          e.style.setProperty(
            "--cover-height",
            (t.clientWidth * t.naturalHeight) / t.naturalWidth + "px"
          ),
...
const removeAccents = (e) => e.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
function darkMode() {
  document
    .querySelector(".it-dark-light")
...
const readingProgress = (e, t) => {
  const n = document.querySelector(e),
    ...
    i = () => {
      ...
      Math.round(o.max - o.value),
        e.top > t && (o.value = 0),
        e.top < t && (o.value = o.max),
        e.top <= t &&
          e.bottom >= t &&
          (o.value = (o.max * Math.abs(e.top - t)) / e.height),
        window.addEventListener("scroll", i);
    };
  window.addEventListener("scroll", i);
};
var e, t;
document.querySelector(".post-progress") &&
  ...
  (function (e, t) {
    ...
    return (
      (o = {
        352: (e) => {
          ...
          var n = (function () {
            ...
            function a(t) {
              t.src &&
                ...
                t.addEventListener(
                  "click",
                  function (e) {
                    if (d.keyboard && (e.metaKey || e.ctrlKey))
                      return window.open(t.src, "_blank");
                    var n, o, i;
                    (e = this),
                      (d.target = e),
                      d.target.classList.contains("lightense-open")
                        ? f()
                        : (s("beforeShow"),
                          ...
                          n.addEventListener(o, function e(t) {
                            Reflect.apply(i, this, t),
                              n.removeEventListener(o, e);
                          }),
                          ((e = new Image()).onload = function () {
                            ...
                            (t = (e = this).width),
                              ...
                              (o =
                                ...
                                0),
                              (i = d.target.getBoundingClientRect()),
                              (r = t / i.width),
                              (s =
                                window.innerWidth ||
                              ...
                              (a =
                                ...
                                0),
                              (l =
                                d.target.getAttribute(
                                  "data-lightense-padding"
                                ) ||
                                d.target.getAttribute("data-padding") ||
                                d.padding),
                              (c = l < s ? s - l : s - u.padding),
                              (l = l < a ? a - l : a - u.padding),
                              (d.scaleFactor =
                                t < c && e < l
                                  ? r
                                  : t / e < c / l
                              ...
                              (l = s / 2),
                              (e = n + a / 2),
                              (c = i.left + o + i.width / 2),
                              (t = i.top + n + i.height / 2),
                              (d.translateX = Math.round(l - c)),
                              (d.translateY = Math.round(e - t)),
                              d.target.classList.add("lightense-open"),
                              (d.wrap = document.createElement("div")),
                              (d.wrap.className = "lightense-wrap"),
                              setTimeout(function () {
                                d.target.style.transform =
                                  "scale(" + d.scaleFactor + ")";
                              }, 20),
                              d.target.parentNode.insertBefore(
                                d.wrap,
                                d.target
                              ),
                              d.wrap.appendChild(d.target),
                              setTimeout(function () {
                              ...
                              (r = {
                                ...
                                background:
                                  ...
                                  d.target.getAttribute("data-background") ||
                                  d.background,
                                zIndex:
                                  d.target.getAttribute(
                              ...
                              setTimeout(function () {
                                d.container.style.opacity = "1";
                              }, 20),
                              window.addEventListener("keyup", m, !1),
                              window.addEventListener("scroll", p, !1),
                              d.container.addEventListener("click", f, !1);
                          }),
                          (e.src = d.target.src));
                  },
                  !1
            ...
            function f() {
              s("beforeHide"),
                window.removeEventListener("keyup", m, !1),
                window.removeEventListener("scroll", p, !1),
                d.container.removeEventListener("click", f, !1),
                d.target.classList.remove("lightense-open"),
                (d.wrap.style.transform = ""),
                (d.target.style.transform = ""),
                d.target.classList.add("lightense-transitioning"),
                (d.container.style.opacity = ""),
                setTimeout(function () {
                  s("afterHide"),
                    (d.container.style.visibility = ""),
                    (d.container.style.backgroundColor = ""),
                    d.wrap.parentNode.replaceChild(d.target, d.wrap),
                    d.target.classList.remove("lightense-transitioning");
                }, d.time);
            }
            function p() {
              Math.abs(d.scrollY - window.scrollY) >= d.offset && f();
            }
            function m(e) {
              e.preventDefault(), 27 === e.keyCode && f();
            }
            return function (e) {
              var t =
                ...
                n =
                  ...
                  null === document.querySelector(".lightense-backdrop")
                    ? ((d.container = document.createElement("div")),
                      (d.container.className = "lightense-backdrop"),
                      document.body.appendChild(d.container))
                    : (d.container = document.querySelector(
                        ".lightense-backdrop"
                      )),
                  r),
                o = n.length;
              if (o) for (var i = 0; i < o; i++) a(n[i]);
              else a(n);
            };
          })();
          e.exports = n;
      ...
      (function e(t) {
        var n = i[t];
        return (
          void 0 !== n || ((n = i[t] = { exports: {} }), o[t](n, n.exports, e)),
          n.exports
        );
      })(352)
    );
  ...
  window.addEventListener(
    "load",
    function () {
      var e = document.querySelector(".post-content .kg-card img"),
    ...
    return function (e, t) {
      ...
      for (var i = 0; i < n.length; i += 1) {
        var r,
          ...
          a,
          l = n[i];
        -1 === l.className.split(" ").indexOf(o) &&
          ((r = l.getAttribute("height")),
          -1 < (s = l.getAttribute("width")).indexOf("%") ||
            -1 < l.style.width.indexOf("%") ||
            ((r = ((r || l.offsetHeight) / (s || l.offsetWidth)) * 100),
            ((s = document.createElement("div")).className = o),
            ((a = s.style).position = "relative"),
            (a.width = "100%"),
            (a.paddingTop = r + "%"),
  ...
  (t = function () {
    ...
    function a(e) {
      var t = this,
        n = (f(this, a), (this._keys = []), (this._keyMap = {}), 0);
      e.forEach(function (e) {
        e = l(e);
        (n += e.weight),
          t._keys.push(e),
    ...
    function l(e) {
      var t = null,
        ...
        o = null,
        i = 1;
      if (m(e) || h(e)) (o = e), (t = u(e)), (n = b(e));
      else {
        if (!s.call(e, "name"))
          throw new Error("Missing ".concat("name", " property in key"));
        var r = e.name,
          o = r;
        if (s.call(e, "weight") && (i = e.weight) <= 0)
          throw new Error(
      ...
      return { path: t, id: n, weight: i, src: o };
    }
    function u(e) {
    ...
    e(E, [
      ...
      },
      {
        ...
        value: function (e, t) {
          v(e) &&
            !c(e) &&
            ((t = { v: e, i: t, n: this.norm.get(e) }), this.records.push(t));
        },
      },
      {
        key: "_addObject",
        value: function (s, e) {
          var a = this,
            l = { i: e, $: {} };
          this.keys.forEach(function (e, t) {
            var e = a.getFn(s, e.path);
            if (v(e))
              if (h(e)) {
                for (
                  var n = [], o = [{ nestedArrIndex: -1, value: e }];
                  o.length;
                  ...
                  v(i) &&
                    (m(i) && !c(i)
                      ? ((r = { v: i, i: r, n: a.norm.get(i) }), n.push(r))
                      : h(i) &&
                        i.forEach(function (e, t) {
                          o.push({ nestedArrIndex: t, value: e });
                        }));
                }
                l.$[t] = n;
              } else c(e) || ((e = { v: e, n: a.norm.get(e) }), (l.$[t] = e));
          }),
            this.records.push(l);
        },
      },
    ...
    function E() {
      var e = (
        ...
        e = void 0 === e ? D.getFn : e;
      f(this, E),
        (this.norm = (function (e) {
          var e = 0 < arguments.length && void 0 !== e ? e : 3,
            n = new Map(),
            o = Math.pow(10, e);
          return {
            get: function (e) {
    ...
    function S(e, t) {
      var n = (
        ...
        n = void 0 === n ? D.getFn : n,
        n = new x({ getFn: n });
      return n.setKeys(e.map(l)), n.setSources(t), n.create(), n;
    }
    function q(e, t) {
      var t = 1 < arguments.length && void 0 !== t ? t : {},
        ...
        r = t.distance,
        r = void 0 === r ? D.distance : r,
        t = t.ignoreLocation,
        t = void 0 === t ? D.ignoreLocation : t,
        n = (void 0 === n ? 0 : n) / e.length;
      return t
        ? n
        : ((e = Math.abs((void 0 === i ? 0 : i) - (void 0 === o ? 0 : o))),
          r ? n + e / r : e ? 1 : n);
    }
    e(k, [
      {
        ...
        value: function (o) {
          ...
          return (
            ...
            this.pattern === o
              ? ((e = { isMatch: !0, score: 0 }),
                f && (e.indices = [[0, o.length - 1]]))
              : ((t = this.options),
                (i = t.location),
                (r = t.distance),
                (s = t.threshold),
                (a = t.findAllMatches),
                (l = t.minMatchCharLength),
                (c = t.ignoreLocation),
                (d = 0),
                (h = !(u = [])),
                this.chunks.forEach(function (e) {
                  var t = e.pattern,
                    ...
                    e = e.startIndex,
                    t = (function (e, t, n, o) {
                      var o = 3 < arguments.length && void 0 !== o ? o : {},
                        i = o.location,
                        i = void 0 === i ? D.location : i,
                        r = o.distance,
                        s = void 0 === r ? D.distance : r,
                        r = o.threshold,
                        r = void 0 === r ? D.threshold : r,
                        a = o.findAllMatches,
                        l = void 0 === a ? D.findAllMatches : a,
                        a = o.minMatchCharLength,
                        a = void 0 === a ? D.minMatchCharLength : a,
                        c = o.includeMatches,
                        c = void 0 === c ? D.includeMatches : c,
                        o = o.ignoreLocation,
                        u = void 0 === o ? D.ignoreLocation : o;
                      if (32 < t.length)
                        throw new Error(
                          "Pattern length exceeds max of ".concat(32, ".")
                        );
                      for (
                        var d,
                          h = t.length,
                        ...
                        var b = q(t, {
                          ...
                          m = Math.min(b, m),
                          g = d + h;
                        if (v) for (var w = 0; w < h; ) w += y[d + w] = 1;
                      }
                      g = -1;
                      for (
                        var x = [], E = 1, S = h + f, C = 1 << (h - 1), L = 0;
                        L < h;
                        L += 1
                      ) {
                        for (var k = 0, I = S; k < I; )
                          q(t, {
                            ...
                            ? (k = I)
                            : (S = I),
                            (I = Math.floor((S - k) / 2 + k));
                        var S = I,
                          T = Math.max(1, p - I + 1),
                          A = l ? f : Math.min(p + I, f) + h,
                          O = Array(A + 2);
                        O[A + 1] = (1 << L) - 1;
                        for (var M = A; T <= M; --M) {
                          var P = M - 1,
                      ...
                      o = { isMatch: 0 <= g, score: Math.max(0.001, E) };
                      return (
                        v &&
                          ((i = (function (e, t) {
                            for (
                              ...
                              l && -1 === r
                                ...
                                : l ||
                                  -1 === r ||
                                  ((l = s - 1) - r + 1 >= o && i.push([r, l]),
                                  (r = -1));
                            }
                            return (
                              n[s - 1] && o <= s - r && i.push([r, s - 1]), i
                            );
                          })(y, a)).length
                            ? c && (o.indices = i)
                            : (o.isMatch = !1)),
                  ...
                  n && (h = !0),
                    (d += e),
                    n && t && (u = [].concat(p(u), p(t)));
                }),
                (e = { isMatch: h, score: h ? d / this.chunks.length : 1 }),
                h && f && (e.indices = u)),
            e
          );
        },
    ...
    function k(e) {
      var n = this,
        ...
        o = t.location,
        o = void 0 === o ? D.location : o,
        i = t.threshold,
        i = void 0 === i ? D.threshold : i,
        r = t.distance,
        r = void 0 === r ? D.distance : r,
        s = t.includeMatches,
        s = void 0 === s ? D.includeMatches : s,
        a = t.findAllMatches,
        a = void 0 === a ? D.findAllMatches : a,
        l = t.minMatchCharLength,
        l = void 0 === l ? D.minMatchCharLength : l,
        c = t.isCaseSensitive,
        c = void 0 === c ? D.isCaseSensitive : c,
        t = t.ignoreLocation,
        t = void 0 === t ? D.ignoreLocation : t;
      if (
        (f(this, k),
        ...
        if (32 < o) {
          for (var d = 0, i = o % 32, h = o - i; d < h; )
            u(this.pattern.substr(d, 32), d), (d += 32);
          i && u(this.pattern.substr((r = o - 32)), r);
        } else u(this.pattern, 0);
      }
    }
    function I(e, t) {
      for (var n = 0, o = L.length; n < o; n += 1) {
        var i = L[n];
      ...
      (n.matches = []),
        v(e) &&
          e.forEach(function (e) {
            ...
            v(e.indices) &&
              e.indices.length &&
              ((t = { indices: e.indices, value: e.value }),
              e.key && (t.key = e.key.src),
              -1 < e.idx && (t.refIndex = e.idx),
              n.matches.push(t));
          });
    }
    function A(e, t) {
      ...
      },
      {
        ...
        value: function () {
          for (
            ...
            var i = this._docs[n];
            e(i, n) && (this.removeAt(n), --n, --o, t.push(i));
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function (e) {
          ...
          return (
            (t = e),
            (i =
              void 0 === (o = (o = { ignoreFieldNorm: o }).ignoreFieldNorm)
                ? D.ignoreFieldNorm
                : o),
            ...
            (function (e, o, t) {
              var t = 2 < arguments.length && void 0 !== t ? t : {},
                n = void 0 === (n = t.includeMatches) ? D.includeMatches : n,
                t = t.includeScore,
                t = void 0 === t ? D.includeScore : t,
                i = [];
              return (
                n && i.push(T),
                t && i.push(A),
            ...
            })((e = g(n) && -1 < n ? e.slice(0, n) : e), this._docs, {
              includeMatches: r,
              includeScore: s,
            })
          );
            ...
            e.forEach(function (e) {
              ...
              v(i) &&
                ...
                a.push({
                  item: i,
                  idx: r,
                  matches: [{ score: n, value: i, norm: e, indices: o }],
                });
            }),
            a
          );
            ...
            e.forEach(function (e) {
              ...
              v(o) &&
                ...
                t.forEach(function (e, t) {
                  n.push.apply(
                    n,
                    p(i._findMatches({ key: e, value: o[t], searcher: r }))
                  );
                }),
                n.length) &&
                s.push({ idx: e, item: o, matches: n });
            }),
            s
          );
        },
    ...
    function M(e) {
      ...
      (this._keyStore = new r(this.options.keys)), this.setCollection(e, n);
    }
    return (
      (O.version = "6.4.6"),
      (O.createIndex = S),
      (O.parseIndex = function (e) {
        var t = (
            1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
          ).getFn,
          t = void 0 === t ? D.getFn : t,
          n = e.keys,
          e = e.records,
          t = new x({ getFn: t });
        return t.setKeys(n), t.setIndexRecords(e), t;
      }),
      (O.config = D),
      O
    );
  ...
  document.addEventListener("DOMContentLoaded", function () {
    !(function (o) {
      ...
      const e = document.body,
        ...
        t = document.querySelectorAll(".search-open"),
        i = document.querySelector(".search-close"),
        r = document.querySelector(".search-input"),
        s = document.querySelector(".search-info"),
        a = document.querySelector(".search-counter"),
        l = document.querySelector(".search-results"),
        c = document.querySelector(".search-counter-results"),
        u = document.querySelector(".search-overlay");
      function d() {
        e.classList.remove("search-is-active"),
          e.classList.add("search-no-active"),
          (r.value = ""),
          (l.innerHTML = ""),
      ...
      n &&
        ...
        t.forEach(function (t) {
          t.addEventListener("click", function () {
            e.classList.add("search-is-active"),
              e.classList.remove("search-no-active"),
                        ...
                        this.value.length <= 2 ||
                          ...
                          e.map(function (e) {
                            ...
                            !0 === options.images &&
                              ...
                              (t.setAttribute("src", e.item.feature_image),
                              s.appendChild(t)),
                              (o.textContent = o.innerHTML += n),
                              (r.textContent = e.item.title),
                              s.setAttribute("href", e.item.url),
                              i.appendChild(r),
                              l.appendChild(s),
                              s.appendChild(i),
                              s.appendChild(o);
  ...
  (function (e, t) {
    ...
    function t(e, o, i) {
      var t,
        ...
        d = !1,
        h =
          (n = e) && n.document && 9 === n.document.nodeType
            ? ((a = (s = n).document),
              (l = a.body),
              (c = a.documentElement),
              {
                ...
                height: function () {
                  return s.innerHeight || c.clientHeight || l.clientHeight;
                },
                scrollY: function () {
                  return void 0 !== s.pageYOffset
                    ? s.pageYOffset
            ...
            : ((r = n),
              {
                ...
                height: function () {
                  return Math.max(r.offsetHeight, r.clientHeight);
                },
                scrollY: function () {
                  return r.scrollTop;
                },
        ...
        p = {};
      function m() {
        var e = Math.round(h.scrollY()),
          t = h.height(),
          n = h.scrollHeight();
        (p.scrollY = e),
          (p.lastScrollY = f),
          (p.direction = f < e ? "down" : "up"),
          (p.distance = Math.abs(e - f)),
          (p.isOutOfBounds = e < 0 || n < e + t),
          (p.top = e <= o.offset[p.direction]),
          (p.bottom = n <= e + t),
          (p.toleranceExceeded = p.distance > o.tolerance[p.direction]),
          i(p),
          (f = e),
          (d = !1);
      }
      function g() {
        d || ((d = !0), (t = requestAnimationFrame(m)));
      }
      var v = !!u && { passive: !0, capture: !1 };
      return (
        e.addEventListener("scroll", g, v),
        m(),
        {
          destroy: function () {
            cancelAnimationFrame(t), e.removeEventListener("scroll", g, v);
          },
        }
      );
    }
  ...
  (() => {
    var n = {
          ...
          e.exports = function (a) {
            ...
            function s(e) {
              var t = a.orderedList ? "ol" : "ul",
                ...
                n = a.listClass + f + a.extraListClasses;
              return (
                e &&
                  (n =
                    (n += f + a.collapsibleClass) + (f + a.isCollapsedClass)),
              ...
              updateToc: function (e) {
                ...
                a.positionFixedSelector &&
                  ...
                  "auto" === a.fixedSidebarOffset &&
                    (a.fixedSidebarOffset = l.offsetTop),
                  t > a.fixedSidebarOffset
                    ? -1 === i.className.indexOf(a.positionFixedClass) &&
                      (i.className += f + a.positionFixedClass)
                    : (i.className = i.className
                        .split(f + a.positionFixedClass)
                        .join("")));
                var o,
                  t,
                  i,
                ...
                h &&
                  ...
                  (u.call(s, function (e, t) {
                    return (function e(t) {
                      ...
                      return (
                        null !== t &&
                          ((n = t.offsetTop), a.hasInnerContainers) &&
                          (n += e(t.offsetParent)),
                        n
                      );
                    })(e) >
                  ...
                  (t = l.querySelectorAll("." + a.linkClass)),
                  c.call(t, function (e) {
                    e.className = e.className
                      .split(f + a.activeLinkClass)
                      .join("");
                  }),
                  (i = l.querySelectorAll("." + a.listItemClass)),
                  c.call(i, function (e) {
                    e.className = e.className
                      .split(f + a.activeListItemClass)
                      .join("");
                  }),
                  (e = l.querySelector(
                    "." +
                    ...
                    (e.className += f + a.activeLinkClass),
                  (r = e && e.parentNode) &&
                    -1 === r.className.indexOf(a.activeListItemClass) &&
                    (r.className += f + a.activeListItemClass),
                  (r = l.querySelectorAll(
                    "." + a.listClass + "." + a.collapsibleClass
                  )),
                  c.call(r, function (e) {
                    -1 === e.className.indexOf(a.isCollapsedClass) &&
                      (e.className += f + a.isCollapsedClass);
                  }),
                  e &&
                    e.nextSibling &&
                    -1 !==
        ...
        971: function (e, t, g) {
              ...
              if ("undefined" != typeof window || f)
                return (
                  ...
                  (c.destroy = function () {
                    var e = m(l);
                    null !== e &&
                      (l.skipRendering || (e && (e.innerHTML = "")),
                      l.scrollContainer &&
                      document.querySelector(l.scrollContainer)
                        ? (document
                            .querySelector(l.scrollContainer)
                            .removeEventListener(
                              "scroll",
                  ...
                  (c.init = function (e) {
                    if (f) {
                      (l = (function () {
                        ...
                        (this.state = {}),
                        l.scrollSmooth &&
                          ((l.duration = l.scrollSmoothDuration),
                          (l.offset = l.scrollSmoothOffset),
                          (c.scrollSmooth = g(374).initSmoothScrolling(l))),
                        (o = u(l)),
                        (i = d(l)),
                        (this._buildHtml = o),
                        (this._parseContent = i),
                        (this._headingsArray = r),
                        c.destroy();
                      e = (function (t) {
                        try {
                          return (
                      ...
                      if (null !== e) {
                        ...
                        if (
                          null !== n &&
                          null !== (r = i.selectHeadings(e, l.headingSelector))
                        )
                          return (
                            (e = i.nestHeadingsArray(r).nest),
                            l.skipRendering || o.render(n, e),
                            (this._scrollListener = p(function (e) {
                              o.updateToc(r), l.disableTocScrollSync || h(l);
                              var t =
                                e &&
                                e.target &&
                              ...
                              ((e &&
                                ...
                                t) &&
                                (o.updateToc(r), l.scrollEndCallback) &&
                            ...
                            (this._clickListener = p(function (e) {
                              l.scrollSmooth && o.disableTocAnimation(e),
                                o.updateToc(r),
                                t && clearTimeout(t),
                                (t = setTimeout(function () {
          ...
          void 0 !== (t = "function" == typeof o ? o.apply(t, n) : o) &&
            (e.exports = t);
        },
        279: (e) => {
          e.exports = function (a) {
            ...
            function c(e) {
              ...
              return e instanceof window.HTMLElement
                ? !a.ignoreHiddenElements || (e.offsetHeight && e.offsetParent)
                  ? ((t =
                  ...
                  function (e, t) {
                    ...
                    if (t) {
                      for (
                        var n = e.nest,
                          t,
                          o = (t = c(t)).headingLevel,
                          i = n,
                          r = l(i),
                          s = o - (r ? r.headingLevel : 0);
                        0 < s && (!(r = l(i)) || o !== r.headingLevel);

                      )
                        r && void 0 !== r.children && (i = r.children), s--;
                      o >= a.collapseDepth && (t.isCollapsed = !0), i.push(t);
                    }
                    return e;
                  },
                  { nest: [] }
        ...
        374: (e, t) => {
          t.initSmoothScrolling = function (u) {
            var d = u.duration,
              h = u.offset,
              f = location.hash ? p(location.href) : location.href;
            function p(e) {
            ...
            document.body.addEventListener(
              ...
              function (t) {
                ...
                function c(e) {
                  (i = e - o),
                    window.scrollTo(0, s.easing(i, r, a, l)),
                    i < l
    ...
    function i(e) {
      ...
      return (
        void 0 !== t ||
          ((t = o[e] = { exports: {} }), n[e].call(t.exports, t, t.exports, i)),
        t.exports
      );
    }
    (i.g = (function () {
